    ...
    render() {
        return (
            <Modal 
                ...
                onHide={this.props.closeAddModalEvent}>
                ...
                <Modal.Body>
                    <form>
                        <FormGroup 
                            controlId="username"
                            validationState={ValidationUtil.getValidationState
                            this.state.nameValue,5,3,0)}>
                        ...
                        <FormGroup 
                            controlId="address" 
                            validationState={ValidationUtil.getValidationState(this.state.addressValue,5,3,0)}>
                ...
                <Modal.Footer>
                    <Button 
                        bsStyle="primary" 
                        onClick={this.props.addUserEvent}>
                            保存
                    </Button>
                    <Button 
                        onClick={this.props.closeAddModalEvent}>
                            关闭
                    </Button>
                </Modal.Footer>
            </Modal>
